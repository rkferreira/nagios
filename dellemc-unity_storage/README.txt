...
[root@]# ./check_unity.py -H myunitybox.foo.com -u monituser -p monitpass -m <module>
...
check_unity.py: error: argument -m/--module is required
 

[root@]# ./check_unity.py -H myunitybox.foo.com -u monituser -p monitpass -m system
